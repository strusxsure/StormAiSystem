...
const MissingEnvError: React.FC = () => (
    <div className="flex items-center justify-center h-screen bg-gray-100 dark:bg-gray-900 text-gray-800 dark:text-gray-200">
        <div className="text-center p-8 bg-white dark:bg-gray-800 rounded-lg shadow-2xl max-w-lg mx-4">
            ...
            <div className="text-left bg-gray-50 dark:bg-gray-700 p-4 rounded-lg font-mono text-sm">
                ...
                <ol className="list-decimal list-inside space-y-2">
                    ...
                    <li>Copy the contents of <code className="bg-gray-200 dark:bg-gray-600 px-1 py-0.5 rounded">.env.example</code> into your new <code className="bg-gray-200 dark:bg-gray-600 px-1 py-0.5 rounded">.env</code> file.</li>
                    <li>Replace the placeholder values (like <code className="bg-gray-200 dark:bg-gray-600 px-1 py-0.5 rounded">"YOUR_FIREBASE_API_KEY"</code>) with your actual Firebase project credentials.</li>
                    <li>Restart the development server.</li>
                </ol>
            </div>
            <p className="mt-6 text-xs text-gray-500">
                If you don't have a Firebase project, you can create one for free at <a href="https://firebase.google.com/" target="_blank" rel="noopener noreferrer" className="text-primary underline">firebase.google.com</a>.
            </p>
        </div>
    </div>
);
...
const App: React.FC = () => {
  // Check for the essential Firebase API key. If it's missing, render an error.
